package com.USWCicrcleLink.server.user.profile.service;
...
import com.USWCicrcleLink.server.user.profile.dto.ProfileDuplicationCheckResponse;
...
public class ProfileService {
    ...
    public ProfileDuplicationCheckResponse checkProfileDuplication(String userName, String studentNumber, String userHp,
            UUID clubUUID) {
        var optionalProfile = profileRepository.findByUserNameAndStudentNumberAndUserHp(userName, studentNumber,
                userHp);
        ...
        return new ProfileDuplicationCheckResponse(true, classification, inTargetClub, clubuuids, clubUUID,
